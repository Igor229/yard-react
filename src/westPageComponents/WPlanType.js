    ...
    return (
            <div className='wtype'>
                <div className='wtype-main'>
                  ...
                  <p className='wtype-main__text'>У містечку WEST TOWN доступна площа - 120 м² та 135 м². Ми пропонуємо на вибір планування з окремою кухнею та вітальнею або ж з гаражем та кухнею-студією на 1-му поверсі. На стадії будівництва ми врахуємо всі ваші індивідуальні побажання щодо планування.</p>
                </div>
